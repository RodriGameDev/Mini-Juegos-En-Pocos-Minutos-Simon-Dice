...
public class GameLogic : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (userList.Count == simonList.Count) { //If they have the same number of color triggered, continue
    ...
    IEnumerator newRound()
    {
        ...
        if (SimonIsPlaying) {
            ...
            for (i = 0; i < max; i++)
            {
                randomNum = Random.Range(0, 4); //Makes a random Number between 0 - 3
